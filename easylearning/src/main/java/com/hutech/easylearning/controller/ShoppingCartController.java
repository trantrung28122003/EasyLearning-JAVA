...
public class ShoppingCartController {
    ...
    public ApiResponse<ShoppingCartItem> createShoppingCartItem(@PathVariable("courseId") String courseId, @RequestBody @Valid ShoppingCartItemRequest request) {

        return ApiResponse.<ShoppingCartItem>builder()
                .result(shoppingCartItemService.createShoppingCartItem(courseId, request))
                .build();
    }
