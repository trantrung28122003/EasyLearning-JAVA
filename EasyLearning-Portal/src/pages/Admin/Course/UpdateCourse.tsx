...
// import { BASE_URL_UPDATE_COURSE } from "../../../constants/API";

const BASE_URL_COURSE = "http://localhost:8080/course"; // Cập nhật URL gốc của bạn
const BASE_URL_UPDATE_COURSE = BASE_URL_COURSE + "/update"; // API cập nhật khóa học
...
const UpdateCourse: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!updatedCourse.courseName || !updatedCourse.coursePrice || !updatedCourse.instructor) {
    ...
    DoCallAPIWithToken(`${BASE_URL_UPDATE_COURSE}/${courseData.id}`, "put", courseData)
      .then((res) => {
        if (res.status === 200) {
          navigate("/admin/course");
        }
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ maxWidth: "1200px", margin: "0 auto", border: "1px solid #dee2e6" }}
      >
