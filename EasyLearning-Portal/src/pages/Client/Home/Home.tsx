            ...
            >
              <div className="service-item text-center pt-3">
                <div className="p-4">
                  ...
                  <p>
                    Phơng pháp giảng dạy linh hoạt và có kinh nghiệm trong lĩnh
                    vực chuyên môn
                  </p>
                </div>
              </div>
            ...
            >
              <div className="service-item text-center pt-3">
                <div className="p-4">
                  ...
                  <p>
                    Thuận tiện cho việc đăng ký, lựa chọn thời gian và lịch học
                    phù hợp với lịch trình cá nhân
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <p className="mb-4">
                ...
                người tiếp cận kiến thức và kỹ năng mới một cách dễ dàng và linh
                hoạt.
              </p>
              <p className="mb-4">
              ...
              <div className="row gy-2 gx-4 mb-4">
                <div className="col-sm-6">
                  <p className="mb-0">
                    <i className="fa fa-arrow-right text-primary me-2"></i>Giảng
                    Viên Chuyên Nghiệp
                  </p>
                </div>
                <div className="col-sm-6">
                  <p className="mb-0">
                    <i className="fa fa-arrow-right text-primary me-2"></i>Đăng
                    Ký Học Trực Tuyến
                  </p>
                </div>
                <div className="col-sm-6">
                ...
                <div className="col-sm-6">
                  <p className="mb-0">
                    <i className="fa fa-arrow-right text-primary me-2"></i>Thực
                    Hiện Dự Án Tại Nhà
                  </p>
                </div>
                <div className="col-sm-6">
                  <p className="mb-0">
                    <i className="fa fa-arrow-right text-primary me-2"></i>Tiết
                    Kiệm Chi
                  </p>
                </div>
                <div className="col-sm-6">
                  <p className="mb-0">
                    <i className="fa fa-arrow-right text-primary me-2"></i>Thời
                    Gian Linh Hoạt
                  </p>
                </div>
              </div>
              ...
              <div className="course-item bg-light">
                ...
                <div className="d-flex border-top">
                  <small className="flex-fill text-center border-end py-2">
                    <i className="fa fa-user-tie text-primary me-2"></i>Trần Anh
                    Tuấn
                  </small>
                  <small className="flex-fill text-center border-end py-2">
                  ...
                  <small className="flex-fill text-center py-2">
                    <i className="fa fa-user text-primary me-2"></i>30 Học Viên
                  </small>
                </div>
              </div>
            </div>
            ...
            >
              <div className="course-item bg-light">
                ...
                <div className="text-center p-4 pb-0">
                  ...
                  <h5 className="mb-4">
                    Hướng Dẫn Digital Marketing Toàn Diện - 24 Khóa Học trong 1
                  </h5>
                </div>
                <div className="d-flex border-top">
                  <small className="flex-fill text-center border-end py-2">
        ...
        <div className="container">
          ...
          <div className="owl-carousel testimonial-carousel position-relative">
            <div className="testimonial-item text-center">
              ...
              <div className="testimonial-text bg-light text-center p-4">
                <p className="mb-0">
                  ...
                  am hiểu và dễ thương, luôn sẵn lòng giải đáp mọi thắc mắc của
                  tôi. Các tài liệu và tài nguyên hỗ trợ rất phong phú và hữu
                  ích. Tôi đã cảm thấy tự tin hơn trong lĩnh vực này sau khi
                  hoàn thành khóa học.
                </p>
              </div>
            </div>
            <div className="testimonial-item text-center">
              ...
              <div className="testimonial-text bg-light text-center p-4">
                <p className="mb-0">
                  ...
                  cuối cùng tôi đã tìm thấy nó ở đây! Khóa học cung cấp một cái
                  nhìn toàn diện về Digital Marketing và hướng dẫn từ cơ bản đến
                  nâng cao. Các bài giảng được trình bày một cách sinh động và
                  dễ hiểu, giúp tôi tiếp cận với những khái niệm khó hiểu một
                  cách dễ dàng. Tôi rất hài lòng với trải nghiệm học tập của
                  mình ở đây
                </p>
              </div>
            </div>
            <div className="testimonial-item text-center">
              ...
              <div className="testimonial-text bg-light text-center p-4">
                <p className="mb-0">
                  Đây là một trang web tuyệt vời cho những ai muốn phát triển kỹ
                  năng cá nhân và chuyên môn. Khóa học rất thú vị và thách thức,
                  giúp tôi mở rộng kiến thức và nâng cao khả năng của mình. Tôi
                  đã học được rất nhiều điều mới và không thể chờ đợi để áp dụng
                  chúng vào thực tế.
                </p>
              </div>
            </div>
